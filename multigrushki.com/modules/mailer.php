...
$header.= "From: =?utf-8?Q?". str_replace("+", "_", str_replace("%", "=", urlencode('Магазин Мульт-Игрушки'))). "?=<sales@alexcreater.in.ua>\r\n";
$header.= "X-Mailer: The Bat! (v3.99.3) Professional\r\n";
$header.= "Reply-To: =?utf-8?Q?". str_replace("+", "_", str_replace("%", "=", urlencode('Noreply'))). "?=<sales@alexcreater.in.ua>\r\n";
$header.= "X-Priority: 3 (Normal)\r\n";
$header.= "Message-ID: <172562218.". date("YmjHis") ."@alexcreater.in.ua>\r\n";
$header.= "To: =?utf-8?Q?". str_replace("+", "_", str_replace("%", "=", urlencode('Елена')))."?=<taobaolarix@gmail.com>\r\n";

$subject = 'Заказ на '. $res['name'] .', тел: '. $_POST['tel'] .'';
...
<ul>
    <li>Город: '. $gorod .'</li>
    <li>Название: '. $res['name'] .'</li>
    <li>Телефон заказчика: '. $_POST['tel'] .'</li>
    <li></li>
    <li></li>
</ul>
';
...
fputs($smtp_conn, "RCPT TO:taobaolarix@gmail.com\r\n");
$data = get_data($smtp_conn);
